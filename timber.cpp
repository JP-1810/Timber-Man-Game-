...
int main()
{
    ...
    Sound chop;
    chop.setBuffer(chopBuffer);#include <SFML/Graphics.hpp>
#include <sstream>
#include <SFML/Audio.hpp>
using namespace sf;
//function declaration
			...
			while (window.pollEvent(event)){
        		...
        		if(Keyboard::isKeyPressed(Keyboard::Return)){
     		 		paused=false;   
     		   		...
     		   		spritePlayer.setPosition(580,720);#include <SFML/Graphics.hpp>
#include <sstream>
#include <SFML/Audio.hpp>
using namespace sf;
//function declaration
	...
	if(acceptInput){
		//    //      //    Right cursor key
	 	...
	 	if (Keyboard::isKeyPressed(Keyboard::Left))
            	...
            	score++;
            	timeRemaining+=(2/score)+.15;
            	spriteAxe.setPosition(AXE_POSITION_LEFT,spriteA#include <SFML/Graphics.hpp>
#include <sstream>
#include <SFML/Audio.hpp>
using namespace sf;
//function declaration
...
int main()
{
    ...
    Sprite spritePlayer;
    spritePlayer.setTexture(texturePlayer);
    spritePlayer.setPosition(580,720);xe.getPosition().y);
            	spritePlayer.setPosition(580,720);
            	//   //   //  // Update the branches
            	updateBranches(score);
            	//   //   //  // Set the flying log to the left
        ...
        {//set the speed of the bee(randomized)
            ...
            beeSpeed = (rand() % 200) + 200; // bee speed will be between 200 and 400
...
int main()
{
	...
	//new log#include <SFML/Graphics.hpp>
#include <sstream>
#include <SFML/Audio.hpp>
using namespace sf;
//function declaration
...
int main()
{
	...
	//SQUISHED
	if(branchPositions[5]==playerSide){#include <SFML/Graphics.hpp>
#include <sstream>
#include <SFML/Audio.hpp>
using namespace sf;
//function declaration
...
int main()
{
    ...
    float timeBarHeight=80;
    timeBar.setSize(Vector2f(TimeBarStartWidth,timeBarHeight));
    timeBar.setFillColor(Color::Green);#include <SFML/Graphics.hpp>
#include <sstream>
#include <SFML/Audio.hpp>
using namespace sf;
//function declaration
...
int main()
{
    ...
    // TREE//#include <SFML/Graphics.hpp>
#include <sstream>
#include <SFML/Audio.hpp>
using namespace sf;
//function declaration
...
int main()
{
    ...
    spritePlayer.setPosition(580,720);
    Texture textureTree;
    textureTree.loadFromFile("asset/graphics/tree.png");#include <SFML/Graphics.hpp>
#include <sstream>
#include <SFML/Audio.hpp>
using namespace sf;
//function declaration
...
int main()
{
    ...
    // CLOUD2
    Sprite spriteCloud2;
    spriteCloud2.setTexture(textureCloud);#include <SFML/Graphics.hpp>
#include <sstream>
#include <SFML/Audio.hpp>
using namespace sf;
//function declaration
...
int main()
{
    ...
    //Prepare 6 branches
    Texture textureBranch;
    textureBranch.loadFromFile("asset/graphics/branch.png");#include <SFML/Graphics.hpp>
#include <sstream>
#include <SFML/Audio.hpp>
using namespace sf;
//function declaration
	...
	if(acceptInput){
		//    //      //    Right cursor key
	 	if (Keyboard::isKeyPressed(Keyboard::Right))
        		{
            	playerSide=side::RIGHT;
            	score++;#include <SFML/Graphics.hpp>
#include <sstream>
#include <SFML/Audio.hpp>
using namespace sf;
//function declaration
